...
foreach ($required in @(
    ...
    'HCH_RELEASE_ADMIN_READ_TOKEN: ${{ secrets.HCH_RELEASE_ADMIN_READ_TOKEN }}',
    'A protected Administration-read token is required to verify immutable releases.',
