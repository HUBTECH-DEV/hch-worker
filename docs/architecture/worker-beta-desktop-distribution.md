...
Status: histórico — substituído em 2026-09-01 pela arquitetura pública do Worker Windows 4.0.0 em C#
Data: 2026-08-29

> Este documento é mantido apenas como registro da alternativa avaliada no
> Beta. Tauri, Node SEA, runtime proprietário separado e a migração para Rust
> não são mais a direção vigente. O produto atual permanece no repositório
> público `HUBTECH-DEV/hch-worker`, com serviço, tray, instalador e onboarding
> versionados como um único Worker.
